; ModuleID = 'mpi_win_interproc.cpp'
source_filename = "mpi_win_interproc.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  %16 = call i32 @_Z13create_windowImEiiPT_b(i32 %15, i64* %6, i1 zeroext false), !dbg !120
  store i32 %16, i32* %9, align 4, !dbg !118
  %17 = load i32, i32* %9, align 4, !dbg !121
  %18 = call i32 @MPI_Win_fence(i32 0, i32 %17), !dbg !122
  %19 = load i32, i32* %8, align 4, !dbg !123
  %20 = icmp sgt i32 %19, 0, !dbg !125
  br i1 %20, label %21, label %27, !dbg !126

; <label>:21:                                     ; preds = %2
  %22 = bitcast i32* %8 to i8*, !dbg !127
  %23 = load i32, i32* %8, align 4, !dbg !129
  %24 = sext i32 %23 to i64, !dbg !129
  %25 = load i32, i32* %9, align 4, !dbg !130
  %26 = call i32 @MPI_Get(i8* %22, i32 1, i32 1275069445, i32 0, i64 %24, i32 1, i32 1275069445, i32 %25), !dbg !131
  br label %33, !dbg !132

; <label>:27:                                     ; preds = %2
  %28 = bitcast i32* %8 to i8*, !dbg !133
  %29 = load i32, i32* %8, align 4, !dbg !135
  %30 = sext i32 %29 to i64, !dbg !135
  %31 = load i32, i32* %9, align 4, !dbg !136
  %32 = call i32 @MPI_Put(i8* %28, i32 1, i32 1275069445, i32 0, i64 %30, i32 1, i32 1275069445, i32 %31), !dbg !137
  br label %33

; <label>:33:                                     ; preds = %27, %21
  %34 = load i32, i32* %9, align 4, !dbg !138
  %35 = call i32 @MPI_Win_fence(i32 0, i32 %34), !dbg !139
  %36 = call i32 @MPI_Win_free(i32* %9), !dbg !140
  %37 = call i32 @MPI_Comm_free(i32* %7), !dbg !141
...
define linkonce_odr i32 @_Z13create_windowImEiiPT_b(i32, i64*, i1 zeroext) #3 comdat !dbg !144 {
  %4 = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i32* %7, metadata !157, metadata !DIExpression()), !dbg !158
  call void @llvm.dbg.declare(metadata i32* %8, metadata !159, metadata !DIExpression()), !dbg !160
  %10 = load i32, i32* %4, align 4, !dbg !161
  store i32 %10, i32* %8, align 4, !dbg !160
  %11 = load i8, i8* %6, align 1, !dbg !162
  %12 = trunc i8 %11 to i1, !dbg !162
  br i1 %12, label %13, label %14, !dbg !164

; <label>:13:                                     ; preds = %3
  store i32 1140850688, i32* %8, align 4, !dbg !165
  br label %14, !dbg !167

; <label>:14:                                     ; preds = %13, %3
  %15 = load i64*, i64** %5, align 8, !dbg !168
  %16 = bitcast i64* %15 to i8*, !dbg !168
  %17 = load i32, i32* %8, align 4, !dbg !169
  %18 = call i32 @MPI_Win_create(i8* %16, i64 8, i32 1, i32 469762048, i32 %17, i32* %7), !dbg !170
  %19 = load i32, i32* %7, align 4, !dbg !171
  ret i32 %19, !dbg !172
}
...
!1 = !DIFile(filename: "mpi_win_interproc.cpp", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!13 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/stdint-intn.h", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!14 = !DIDerivedType(tag: DW_TAG_typedef, name: "__int8_t", file: !15, line: 36, baseType: !16)
!15 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types.h", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!16 = !DIBasicType(name: "signed char", size: 8, encoding: DW_ATE_signed_char)
!17 = !DIFile(filename: "/usr/bin/../lib/gcc/x86_64-linux-gnu/7.3.0/../../../../include/c++/7.3.0/cstdint", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
...
!31 = !DIFile(filename: "/usr/include/stdint.h", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
...
!53 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/stdint-uintn.h", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
...
!93 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 24, type: !94, isLocal: false, isDefinition: true, scopeLine: 24, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!94 = !DISubroutineType(types: !95)
!95 = !{!6, !6, !96}
!96 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !97, size: 64)
!97 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !98, size: 64)
!98 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!99 = !DILocalVariable(name: "argc", arg: 1, scope: !93, file: !1, line: 24, type: !6)
!100 = !DILocation(line: 24, column: 15, scope: !93)
!101 = !DILocalVariable(name: "argv", arg: 2, scope: !93, file: !1, line: 24, type: !96)
!102 = !DILocation(line: 24, column: 28, scope: !93)
!103 = !DILocation(line: 25, column: 3, scope: !93)
!104 = !DILocalVariable(name: "memory", scope: !93, file: !1, line: 27, type: !105)
!105 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !106, line: 62, baseType: !67)
!106 = !DIFile(filename: "/usr/include/clang/6.0.0/include/stddef.h", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!107 = !DILocation(line: 27, column: 10, scope: !93)
!108 = !DILocalVariable(name: "other_comm", scope: !93, file: !1, line: 28, type: !4)
!109 = !DILocation(line: 28, column: 12, scope: !93)
!110 = !DILocalVariable(name: "rank", scope: !93, file: !1, line: 29, type: !6)
!111 = !DILocation(line: 29, column: 7, scope: !93)
!112 = !DILocation(line: 31, column: 3, scope: !93)
!113 = !DILocation(line: 35, column: 7, scope: !93)
!114 = !DILocation(line: 36, column: 7, scope: !93)
!115 = !DILocation(line: 33, column: 3, scope: !93)
!116 = !DILocalVariable(name: "window", scope: !93, file: !1, line: 40, type: !117)
!117 = !DIDerivedType(tag: DW_TAG_typedef, name: "MPI_Win", file: !5, line: 296, baseType: !6)
!118 = !DILocation(line: 40, column: 11, scope: !93)
!119 = !DILocation(line: 40, column: 42, scope: !93)
!120 = !DILocation(line: 40, column: 20, scope: !93)
!121 = !DILocation(line: 42, column: 20, scope: !93)
!122 = !DILocation(line: 42, column: 3, scope: !93)
!123 = !DILocation(line: 44, column: 7, scope: !124)
!124 = distinct !DILexicalBlock(scope: !93, file: !1, line: 44, column: 7)
!125 = !DILocation(line: 44, column: 12, scope: !124)
!126 = !DILocation(line: 44, column: 7, scope: !93)
!127 = !DILocation(line: 46, column: 9, scope: !128)
!128 = distinct !DILexicalBlock(scope: !124, file: !1, line: 44, column: 17)
!129 = !DILocation(line: 50, column: 9, scope: !128)
!130 = !DILocation(line: 53, column: 9, scope: !128)
!131 = !DILocation(line: 45, column: 5, scope: !128)
!132 = !DILocation(line: 55, column: 3, scope: !128)
!133 = !DILocation(line: 57, column: 9, scope: !134)
!134 = distinct !DILexicalBlock(scope: !124, file: !1, line: 55, column: 10)
!135 = !DILocation(line: 61, column: 9, scope: !134)
!136 = !DILocation(line: 64, column: 9, scope: !134)
!137 = !DILocation(line: 56, column: 5, scope: !134)
!138 = !DILocation(line: 68, column: 20, scope: !93)
!139 = !DILocation(line: 68, column: 3, scope: !93)
!140 = !DILocation(line: 70, column: 3, scope: !93)
!141 = !DILocation(line: 72, column: 3, scope: !93)
!142 = !DILocation(line: 74, column: 3, scope: !93)
!143 = !DILocation(line: 76, column: 3, scope: !93)
!144 = distinct !DISubprogram(name: "create_window<unsigned long>", linkageName: "_Z13create_windowImEiiPT_b", scope: !1, file: !1, line: 4, type: !145, isLocal: false, isDefinition: true, scopeLine: 4, flags: DIFlagPrototyped, isOptimized: false, unit: !0, templateParams: !149, variables: !2)
...
!149 = !{!150}
!150 = !DITemplateTypeParameter(name: "T", type: !67)
!151 = !DILocalVariable(name: "comm", arg: 1, scope: !144, file: !1, line: 4, type: !4)
!152 = !DILocation(line: 4, column: 33, scope: !144)
!153 = !DILocalVariable(name: "mem", arg: 2, scope: !144, file: !1, line: 4, type: !147)
!154 = !DILocation(line: 4, column: 42, scope: !144)
!155 = !DILocalVariable(name: "flag", arg: 3, scope: !144, file: !1, line: 4, type: !148)
!156 = !DILocation(line: 4, column: 52, scope: !144)
!157 = !DILocalVariable(name: "window", scope: !144, file: !1, line: 5, type: !117)
!158 = !DILocation(line: 5, column: 11, scope: !144)
!159 = !DILocalVariable(name: "comm_to_use", scope: !144, file: !1, line: 6, type: !4)
!160 = !DILocation(line: 6, column: 12, scope: !144)
!161 = !DILocation(line: 6, column: 26, scope: !144)
!162 = !DILocation(line: 8, column: 7, scope: !163)
!163 = distinct !DILexicalBlock(scope: !144, file: !1, line: 8, column: 7)
!164 = !DILocation(line: 8, column: 7, scope: !144)
!165 = !DILocation(line: 9, column: 17, scope: !166)
!166 = distinct !DILexicalBlock(scope: !163, file: !1, line: 8, column: 13)
!167 = !DILocation(line: 10, column: 3, scope: !166)
!168 = !DILocation(line: 13, column: 7, scope: !144)
!169 = !DILocation(line: 17, column: 7, scope: !144)
!170 = !DILocation(line: 12, column: 3, scope: !144)
!171 = !DILocation(line: 21, column: 10, scope: !144)
!172 = !DILocation(line: 21, column: 3, scope: !144)
