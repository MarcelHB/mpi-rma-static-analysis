; ModuleID = 'mpi_win_dyn_memory.cpp'
source_filename = "mpi_win_dyn_memory.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  %11 = call i32 @MPI_Comm_rank(i32 1140850688, i32* %7), !dbg !110
  call void @llvm.dbg.declare(metadata i32* %8, metadata !111, metadata !DIExpression()), !dbg !113
  %12 = bitcast i64* %6 to i8*, !dbg !114
  %13 = call i32 @MPI_Win_create(i8* %12, i64 8, i32 1, i32 469762048, i32 1140850688, i32* %8), !dbg !115
  %14 = load i32, i32* %8, align 4, !dbg !116
  %15 = call i32 @MPI_Win_fence(i32 0, i32 %14), !dbg !117
  %16 = bitcast i32* %7 to i8*, !dbg !118
  %17 = load i32, i32* %7, align 4, !dbg !119
  %18 = sext i32 %17 to i64, !dbg !119
  %19 = load i32, i32* %8, align 4, !dbg !120
  %20 = call i32 @MPI_Get(i8* %16, i32 1, i32 1275069445, i32 0, i64 %18, i32 1, i32 1275069445, i32 %19), !dbg !121
  %21 = load i32, i32* %8, align 4, !dbg !122
  %22 = call i32 @MPI_Win_fence(i32 0, i32 %21), !dbg !123
  %23 = load i32, i32* %7, align 4, !dbg !124
  %24 = icmp sgt i32 %23, 0, !dbg !126
  br i1 %24, label %25, label %29, !dbg !127

; <label>:25:                                     ; preds = %2
  call void @llvm.dbg.declare(metadata i64* %9, metadata !128, metadata !DIExpression()), !dbg !130
  store i64 0, i64* %9, align 8, !dbg !130
  %26 = load i32, i32* %8, align 4, !dbg !131
  %27 = bitcast i64* %9 to i8*, !dbg !132
  %28 = call i32 @MPI_Win_attach(i32 %26, i8* %27, i64 8), !dbg !133
  br label %29, !dbg !134

; <label>:29:                                     ; preds = %25, %2
  %30 = load i32, i32* %8, align 4, !dbg !135
  %31 = call i32 @MPI_Win_fence(i32 0, i32 %30), !dbg !136
  %32 = call i32 @MPI_Win_free(i32* %8), !dbg !137
  %33 = call i32 @MPI_Finalize(), !dbg !138
  ret i32 0, !dbg !139
}
...
declare i32 @MPI_Win_attach(i32, i8*, i64) #2
...
!1 = !DIFile(filename: "mpi_win_dyn_memory.cpp", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!110 = !DILocation(line: 9, column: 3, scope: !93)
!111 = !DILocalVariable(name: "window", scope: !93, file: !1, line: 11, type: !112)
!112 = !DIDerivedType(tag: DW_TAG_typedef, name: "MPI_Win", file: !5, line: 296, baseType: !6)
!113 = !DILocation(line: 11, column: 11, scope: !93)
!114 = !DILocation(line: 13, column: 7, scope: !93)
!115 = !DILocation(line: 12, column: 3, scope: !93)
!116 = !DILocation(line: 21, column: 20, scope: !93)
!117 = !DILocation(line: 21, column: 3, scope: !93)
!118 = !DILocation(line: 24, column: 7, scope: !93)
!119 = !DILocation(line: 28, column: 7, scope: !93)
!120 = !DILocation(line: 31, column: 7, scope: !93)
!121 = !DILocation(line: 23, column: 3, scope: !93)
!122 = !DILocation(line: 34, column: 20, scope: !93)
!123 = !DILocation(line: 34, column: 3, scope: !93)
!124 = !DILocation(line: 36, column: 7, scope: !125)
!125 = distinct !DILexicalBlock(scope: !93, file: !1, line: 36, column: 7)
!126 = !DILocation(line: 36, column: 12, scope: !125)
!127 = !DILocation(line: 36, column: 7, scope: !93)
!128 = !DILocalVariable(name: "alsoVeryLocalMemory", scope: !129, file: !1, line: 37, type: !105)
!129 = distinct !DILexicalBlock(scope: !125, file: !1, line: 36, column: 17)
!130 = !DILocation(line: 37, column: 12, scope: !129)
!131 = !DILocation(line: 39, column: 20, scope: !129)
!132 = !DILocation(line: 39, column: 28, scope: !129)
!133 = !DILocation(line: 39, column: 5, scope: !129)
!134 = !DILocation(line: 40, column: 3, scope: !129)
!135 = !DILocation(line: 42, column: 20, scope: !93)
!136 = !DILocation(line: 42, column: 3, scope: !93)
!137 = !DILocation(line: 44, column: 3, scope: !93)
!138 = !DILocation(line: 46, column: 3, scope: !93)
!139 = !DILocation(line: 48, column: 3, scope: !93)
