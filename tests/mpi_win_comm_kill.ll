; ModuleID = 'mpi_win_comm_kill.cpp'
source_filename = "mpi_win_comm_kill.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  %12 = call i32 @MPI_Comm_rank(i32 1140850688, i32* %9), !dbg !114
  %13 = load i32, i32* %9, align 4, !dbg !115
  %14 = load i32, i32* %9, align 4, !dbg !116
  %15 = call i32 @MPI_Comm_split(i32 1140850688, i32 %13, i32 %14, i32* %7), !dbg !117
  call void @llvm.dbg.declare(metadata i32* %10, metadata !118, metadata !DIExpression()), !dbg !120
  %16 = bitcast i64* %6 to i8*, !dbg !121
  %17 = load i32, i32* %7, align 4, !dbg !122
  %18 = call i32 @MPI_Win_create(i8* %16, i64 8, i32 1, i32 469762048, i32 %17, i32* %10), !dbg !123
  %19 = load i32, i32* %10, align 4, !dbg !124
  %20 = call i32 @MPI_Win_fence(i32 0, i32 %19), !dbg !125
  %21 = load i32, i32* %9, align 4, !dbg !126
  %22 = icmp sgt i32 %21, 0, !dbg !128
  br i1 %22, label %23, label %30, !dbg !129

; <label>:23:                                     ; preds = %2
  %24 = bitcast i32* %9 to i8*, !dbg !130
  %25 = load i32, i32* %9, align 4, !dbg !132
  %26 = sext i32 %25 to i64, !dbg !132
  %27 = load i32, i32* %10, align 4, !dbg !133
  %28 = call i32 @MPI_Get(i8* %24, i32 1, i32 1275069445, i32 0, i64 %26, i32 1, i32 1275069445, i32 %27), !dbg !134
  %29 = call i32 @MPI_Comm_free(i32* %8), !dbg !135
  br label %37, !dbg !136

; <label>:30:                                     ; preds = %2
  %31 = bitcast i32* %9 to i8*, !dbg !137
  %32 = load i32, i32* %9, align 4, !dbg !139
  %33 = sext i32 %32 to i64, !dbg !139
  %34 = load i32, i32* %10, align 4, !dbg !140
  %35 = call i32 @MPI_Put(i8* %31, i32 1, i32 1275069445, i32 0, i64 %33, i32 1, i32 1275069445, i32 %34), !dbg !141
  %36 = call i32 @MPI_Comm_free(i32* %7), !dbg !142
  br label %37

; <label>:37:                                     ; preds = %30, %23
  %38 = load i32, i32* %10, align 4, !dbg !143
  %39 = call i32 @MPI_Win_fence(i32 0, i32 %38), !dbg !144
  %40 = call i32 @MPI_Win_free(i32* %10), !dbg !145
  %41 = call i32 @MPI_Comm_free(i32* %7), !dbg !146
...
!1 = !DIFile(filename: "mpi_win_comm_kill.cpp", directory: "/home/marcelhb/Sources/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!110 = !DILocalVariable(name: "other_comm2", scope: !93, file: !1, line: 7, type: !4)
!111 = !DILocation(line: 7, column: 24, scope: !93)
!112 = !DILocalVariable(name: "rank", scope: !93, file: !1, line: 8, type: !6)
!113 = !DILocation(line: 8, column: 7, scope: !93)
!114 = !DILocation(line: 10, column: 3, scope: !93)
!115 = !DILocation(line: 14, column: 7, scope: !93)
!116 = !DILocation(line: 15, column: 7, scope: !93)
!117 = !DILocation(line: 12, column: 3, scope: !93)
!118 = !DILocalVariable(name: "window", scope: !93, file: !1, line: 19, type: !119)
!119 = !DIDerivedType(tag: DW_TAG_typedef, name: "MPI_Win", file: !5, line: 296, baseType: !6)
!120 = !DILocation(line: 19, column: 11, scope: !93)
!121 = !DILocation(line: 22, column: 7, scope: !93)
!122 = !DILocation(line: 26, column: 7, scope: !93)
!123 = !DILocation(line: 21, column: 3, scope: !93)
!124 = !DILocation(line: 30, column: 20, scope: !93)
!125 = !DILocation(line: 30, column: 3, scope: !93)
!126 = !DILocation(line: 32, column: 7, scope: !127)
!127 = distinct !DILexicalBlock(scope: !93, file: !1, line: 32, column: 7)
!128 = !DILocation(line: 32, column: 12, scope: !127)
!129 = !DILocation(line: 32, column: 7, scope: !93)
!130 = !DILocation(line: 34, column: 9, scope: !131)
!131 = distinct !DILexicalBlock(scope: !127, file: !1, line: 32, column: 17)
!132 = !DILocation(line: 38, column: 9, scope: !131)
!133 = !DILocation(line: 41, column: 9, scope: !131)
!134 = !DILocation(line: 33, column: 5, scope: !131)
!135 = !DILocation(line: 44, column: 5, scope: !131)
!136 = !DILocation(line: 45, column: 3, scope: !131)
!137 = !DILocation(line: 47, column: 9, scope: !138)
!138 = distinct !DILexicalBlock(scope: !127, file: !1, line: 45, column: 10)
!139 = !DILocation(line: 51, column: 9, scope: !138)
!140 = !DILocation(line: 54, column: 9, scope: !138)
!141 = !DILocation(line: 46, column: 5, scope: !138)
!142 = !DILocation(line: 57, column: 5, scope: !138)
!143 = !DILocation(line: 60, column: 20, scope: !93)
!144 = !DILocation(line: 60, column: 3, scope: !93)
!145 = !DILocation(line: 62, column: 3, scope: !93)
!146 = !DILocation(line: 64, column: 3, scope: !93)
!147 = !DILocation(line: 66, column: 3, scope: !93)
!148 = !DILocation(line: 68, column: 3, scope: !93)
