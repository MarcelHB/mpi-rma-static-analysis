; ModuleID = 'mpi_win_fence_flags.cpp'
source_filename = "mpi_win_fence_flags.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  br i1 %21, label %22, label %25, !dbg !127

; <label>:22:                                     ; preds = %2
  %23 = load i32, i32* %9, align 4, !dbg !128
  %24 = call i32 @MPI_Win_fence(i32 8192, i32 %23), !dbg !130
  br label %28, !dbg !131

; <label>:25:                                     ; preds = %2
  %26 = load i32, i32* %9, align 4, !dbg !132
  %27 = call i32 @MPI_Win_fence(i32 16384, i32 %26), !dbg !134
  br label %28

; <label>:28:                                     ; preds = %25, %22
  %29 = bitcast i32* %8 to i8*, !dbg !135
  %30 = load i32, i32* %8, align 4, !dbg !136
  %31 = sext i32 %30 to i64, !dbg !136
  %32 = load i32, i32* %9, align 4, !dbg !137
  %33 = call i32 @MPI_Get(i8* %29, i32 1, i32 1275069445, i32 0, i64 %31, i32 1, i32 1275069445, i32 %32), !dbg !138
  %34 = load i32, i32* %9, align 4, !dbg !139
  %35 = call i32 @MPI_Win_fence(i32 0, i32 %34), !dbg !140
  %36 = call i32 @MPI_Win_free(i32* %9), !dbg !141
  %37 = call i32 @MPI_Comm_free(i32* %7), !dbg !142
  %38 = call i32 @MPI_Finalize(), !dbg !143
  ret i32 0, !dbg !144
}
...
!1 = !DIFile(filename: "mpi_win_fence_flags.cpp", directory: "/home/marcelhb/Sources/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!128 = !DILocation(line: 33, column: 39, scope: !129)
!129 = distinct !DILexicalBlock(scope: !125, file: !1, line: 32, column: 17)
!130 = !DILocation(line: 33, column: 5, scope: !129)
!131 = !DILocation(line: 34, column: 3, scope: !129)
!132 = !DILocation(line: 35, column: 39, scope: !133)
!133 = distinct !DILexicalBlock(scope: !125, file: !1, line: 34, column: 10)
!134 = !DILocation(line: 35, column: 5, scope: !133)
!135 = !DILocation(line: 39, column: 7, scope: !93)
!136 = !DILocation(line: 43, column: 7, scope: !93)
!137 = !DILocation(line: 46, column: 7, scope: !93)
!138 = !DILocation(line: 38, column: 3, scope: !93)
!139 = !DILocation(line: 49, column: 20, scope: !93)
!140 = !DILocation(line: 49, column: 3, scope: !93)
!141 = !DILocation(line: 51, column: 3, scope: !93)
!142 = !DILocation(line: 53, column: 3, scope: !93)
!143 = !DILocation(line: 55, column: 3, scope: !93)
!144 = !DILocation(line: 57, column: 3, scope: !93)
