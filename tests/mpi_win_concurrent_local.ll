; ModuleID = 'mpi_win_concurrent_local.cpp'
source_filename = "mpi_win_concurrent_local.cpp"
...
; <label>:17:                                     ; preds = %2
  %18 = load i32, i32* %9, align 4, !dbg !123
  %19 = call i32 @MPI_Win_fence(i32 0, i32 %18), !dbg !125
  %20 = getelementptr inbounds [128 x i8], [128 x i8]* %6, i64 0, i64 0, !dbg !126
  store i8 123, i8* %20, align 16, !dbg !127
  %21 = load i32, i32* %9, align 4, !dbg !128
  %22 = call i32 @MPI_Win_fence(i32 0, i32 %21), !dbg !129
  br label %31, !dbg !130

; <label>:23:                                     ; preds = %2
  %24 = load i32, i32* %9, align 4, !dbg !131
  %25 = call i32 @MPI_Win_fence(i32 0, i32 %24), !dbg !133
  %26 = bitcast i32* %8 to i8*, !dbg !134
  %27 = load i32, i32* %9, align 4, !dbg !135
  %28 = call i32 @MPI_Put(i8* %26, i32 1, i32 1275069445, i32 0, i64 0, i32 1, i32 1275069445, i32 %27), !dbg !136
  %29 = load i32, i32* %9, align 4, !dbg !137
  %30 = call i32 @MPI_Win_fence(i32 0, i32 %29), !dbg !138
  br label %31

; <label>:31:                                     ; preds = %23, %17
  %32 = call i32 @MPI_Win_free(i32* %9), !dbg !139
  %33 = call i32 @MPI_Finalize(), !dbg !140
  ret i32 0, !dbg !141
}
...
!1 = !DIFile(filename: "mpi_win_concurrent_local.cpp", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!109 = !DILocalVariable(name: "rank", scope: !93, file: !1, line: 7, type: !6)
!110 = !DILocation(line: 7, column: 7, scope: !93)
!111 = !DILocalVariable(name: "someValue", scope: !93, file: !1, line: 7, type: !6)
!112 = !DILocation(line: 7, column: 18, scope: !93)
!113 = !DILocalVariable(name: "window", scope: !93, file: !1, line: 8, type: !114)
!114 = !DIDerivedType(tag: DW_TAG_typedef, name: "MPI_Win", file: !5, line: 296, baseType: !6)
!115 = !DILocation(line: 8, column: 11, scope: !93)
!116 = !DILocation(line: 10, column: 3, scope: !93)
!117 = !DILocation(line: 13, column: 7, scope: !93)
!118 = !DILocation(line: 12, column: 3, scope: !93)
!119 = !DILocation(line: 21, column: 12, scope: !120)
!120 = distinct !DILexicalBlock(scope: !93, file: !1, line: 21, column: 7)
!121 = !DILocation(line: 21, column: 9, scope: !120)
!122 = !DILocation(line: 21, column: 7, scope: !93)
!123 = !DILocation(line: 22, column: 22, scope: !124)
!124 = distinct !DILexicalBlock(scope: !120, file: !1, line: 21, column: 18)
!125 = !DILocation(line: 22, column: 5, scope: !124)
!126 = !DILocation(line: 24, column: 5, scope: !124)
!127 = !DILocation(line: 24, column: 15, scope: !124)
!128 = !DILocation(line: 26, column: 22, scope: !124)
!129 = !DILocation(line: 26, column: 5, scope: !124)
!130 = !DILocation(line: 27, column: 3, scope: !124)
!131 = !DILocation(line: 28, column: 22, scope: !132)
!132 = distinct !DILexicalBlock(scope: !120, file: !1, line: 27, column: 10)
!133 = !DILocation(line: 28, column: 5, scope: !132)
!134 = !DILocation(line: 31, column: 9, scope: !132)
!135 = !DILocation(line: 38, column: 9, scope: !132)
!136 = !DILocation(line: 30, column: 5, scope: !132)
!137 = !DILocation(line: 41, column: 22, scope: !132)
!138 = !DILocation(line: 41, column: 5, scope: !132)
!139 = !DILocation(line: 44, column: 3, scope: !93)
!140 = !DILocation(line: 46, column: 3, scope: !93)
!141 = !DILocation(line: 48, column: 3, scope: !93)
