; ModuleID = 'mpi_win_subseq.cpp'
source_filename = "mpi_win_subseq.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  br i1 %21, label %22, label %28, !dbg !127
...
; <label>:28:                                     ; preds = %22, %2
  ...
  %30 = call i32 @MPI_Win_fence(i32 0, i32 %29), !dbg !135
  %31 = call i32 @MPI_Win_free(i32* %9), !dbg !136
  %32 = bitcast i64* %6 to i8*, !dbg !137
  %33 = load i32, i32* %7, align 4, !dbg !138
  %34 = call i32 @MPI_Win_create(i8* %32, i64 8, i32 1, i32 469762048, i32 %33, i32* %9), !dbg !139
  %35 = load i32, i32* %9, align 4, !dbg !140
  %36 = call i32 @MPI_Win_fence(i32 0, i32 %35), !dbg !141
  %37 = load i32, i32* %8, align 4, !dbg !142
  %38 = icmp sgt i32 %37, 0, !dbg !144
  br i1 %38, label %39, label %45, !dbg !145

; <label>:39:                                     ; preds = %28
  %40 = bitcast i32* %8 to i8*, !dbg !146
  %41 = load i32, i32* %8, align 4, !dbg !148
  %42 = sext i32 %41 to i64, !dbg !148
  %43 = load i32, i32* %9, align 4, !dbg !149
  %44 = call i32 @MPI_Put(i8* %40, i32 1, i32 1275069445, i32 0, i64 %42, i32 1, i32 1275069445, i32 %43), !dbg !150
  br label %45, !dbg !151

; <label>:45:                                     ; preds = %39, %28
  %46 = load i32, i32* %9, align 4, !dbg !152
  %47 = call i32 @MPI_Win_fence(i32 0, i32 %46), !dbg !153
  %48 = call i32 @MPI_Win_free(i32* %9), !dbg !154
  %49 = call i32 @MPI_Comm_free(i32* %7), !dbg !155
  %50 = call i32 @MPI_Finalize(), !dbg !156
  ret i32 0, !dbg !157
}
...
!1 = !DIFile(filename: "mpi_win_subseq.cpp", directory: "/home/marcelhb/Sources/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!133 = !DILocation(line: 43, column: 3, scope: !129)
!134 = !DILocation(line: 45, column: 20, scope: !93)
!135 = !DILocation(line: 45, column: 3, scope: !93)
!136 = !DILocation(line: 47, column: 3, scope: !93)
!137 = !DILocation(line: 50, column: 7, scope: !93)
!138 = !DILocation(line: 54, column: 7, scope: !93)
!139 = !DILocation(line: 49, column: 3, scope: !93)
!140 = !DILocation(line: 58, column: 20, scope: !93)
!141 = !DILocation(line: 58, column: 3, scope: !93)
!142 = !DILocation(line: 60, column: 7, scope: !143)
!143 = distinct !DILexicalBlock(scope: !93, file: !1, line: 60, column: 7)
!144 = !DILocation(line: 60, column: 12, scope: !143)
!145 = !DILocation(line: 60, column: 7, scope: !93)
!146 = !DILocation(line: 62, column: 9, scope: !147)
!147 = distinct !DILexicalBlock(scope: !143, file: !1, line: 60, column: 17)
!148 = !DILocation(line: 66, column: 9, scope: !147)
!149 = !DILocation(line: 69, column: 9, scope: !147)
!150 = !DILocation(line: 61, column: 5, scope: !147)
!151 = !DILocation(line: 71, column: 3, scope: !147)
!152 = !DILocation(line: 73, column: 20, scope: !93)
!153 = !DILocation(line: 73, column: 3, scope: !93)
!154 = !DILocation(line: 75, column: 3, scope: !93)
!155 = !DILocation(line: 77, column: 3, scope: !93)
!156 = !DILocation(line: 79, column: 3, scope: !93)
!157 = !DILocation(line: 81, column: 3, scope: !93)
