; ModuleID = 'mpi_win_struct.cpp'
source_filename = "mpi_win_struct.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  call void @llvm.dbg.declare(metadata %struct.Context* %9, metadata !116, metadata !DIExpression()), !dbg !122
  %16 = getelementptr inbounds %struct.Context, %struct.Context* %9, i32 0, i32 0, !dbg !123
  store i64 1, i64* %16, align 8, !dbg !124
  call void @llvm.dbg.declare(metadata %struct.Context** %10, metadata !125, metadata !DIExpression()), !dbg !127
  store %struct.Context* %9, %struct.Context** %10, align 8, !dbg !127
  %17 = bitcast i64* %6 to i8*, !dbg !128
  %18 = load i32, i32* %7, align 4, !dbg !129
  %19 = load %struct.Context*, %struct.Context** %10, align 8, !dbg !130
  %20 = getelementptr inbounds %struct.Context, %struct.Context* %19, i32 0, i32 1, !dbg !131
  %21 = call i32 @MPI_Win_create(i8* %17, i64 8, i32 1, i32 469762048, i32 %18, i32* %20), !dbg !132
  %22 = getelementptr inbounds %struct.Context, %struct.Context* %9, i32 0, i32 1, !dbg !133
  %23 = load i32, i32* %22, align 8, !dbg !133
  %24 = call i32 @MPI_Win_fence(i32 0, i32 %23), !dbg !134
  %25 = bitcast i32* %8 to i8*, !dbg !135
  %26 = load i32, i32* %8, align 4, !dbg !136
  %27 = sext i32 %26 to i64, !dbg !136
  %28 = getelementptr inbounds %struct.Context, %struct.Context* %9, i32 0, i32 1, !dbg !137
  %29 = load i32, i32* %28, align 8, !dbg !137
  %30 = call i32 @MPI_Get(i8* %25, i32 1, i32 1275069445, i32 0, i64 %27, i32 1, i32 1275069445, i32 %29), !dbg !138
  %31 = bitcast i32* %8 to i8*, !dbg !139
  %32 = load i32, i32* %8, align 4, !dbg !140
  %33 = sext i32 %32 to i64, !dbg !140
  %34 = load %struct.Context*, %struct.Context** %10, align 8, !dbg !141
  %35 = getelementptr inbounds %struct.Context, %struct.Context* %34, i32 0, i32 1, !dbg !142
  %36 = load i32, i32* %35, align 8, !dbg !142
  %37 = call i32 @MPI_Put(i8* %31, i32 1, i32 1275069445, i32 0, i64 %33, i32 1, i32 1275069445, i32 %36), !dbg !143
  %38 = getelementptr inbounds %struct.Context, %struct.Context* %9, i32 0, i32 1, !dbg !144
  %39 = load i32, i32* %38, align 8, !dbg !144
  %40 = call i32 @MPI_Win_fence(i32 0, i32 %39), !dbg !145
  %41 = getelementptr inbounds %struct.Context, %struct.Context* %9, i32 0, i32 1, !dbg !146
  %42 = call i32 @MPI_Win_free(i32* %41), !dbg !147
  %43 = call i32 @MPI_Comm_free(i32* %7), !dbg !148
  %44 = call i32 @MPI_Finalize(), !dbg !149
  ret i32 0, !dbg !150
}
...
!1 = !DIFile(filename: "mpi_win_struct.cpp", directory: "/home/marcelhb/Sources/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!93 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 8, type: !94, isLocal: false, isDefinition: true, scopeLine: 8, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!94 = !DISubroutineType(types: !95)
!95 = !{!6, !6, !96}
!96 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !97, size: 64)
!97 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !98, size: 64)
!98 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!99 = !DILocalVariable(name: "argc", arg: 1, scope: !93, file: !1, line: 8, type: !6)
!100 = !DILocation(line: 8, column: 15, scope: !93)
!101 = !DILocalVariable(name: "argv", arg: 2, scope: !93, file: !1, line: 8, type: !96)
!102 = !DILocation(line: 8, column: 28, scope: !93)
!103 = !DILocation(line: 9, column: 3, scope: !93)
!104 = !DILocalVariable(name: "memory", scope: !93, file: !1, line: 11, type: !105)
...
!107 = !DILocation(line: 11, column: 10, scope: !93)
!108 = !DILocalVariable(name: "other_comm", scope: !93, file: !1, line: 12, type: !4)
!109 = !DILocation(line: 12, column: 12, scope: !93)
!110 = !DILocalVariable(name: "rank", scope: !93, file: !1, line: 13, type: !6)
!111 = !DILocation(line: 13, column: 7, scope: !93)
!112 = !DILocation(line: 15, column: 3, scope: !93)
!113 = !DILocation(line: 19, column: 7, scope: !93)
!114 = !DILocation(line: 20, column: 7, scope: !93)
!115 = !DILocation(line: 17, column: 3, scope: !93)
!116 = !DILocalVariable(name: "ctx", scope: !93, file: !1, line: 24, type: !117)
!117 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "Context", file: !1, line: 3, size: 128, elements: !118, identifier: "_ZTS7Context")
!118 = !{!119, !120}
!119 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !117, file: !1, line: 4, baseType: !105, size: 64)
!120 = !DIDerivedType(tag: DW_TAG_member, name: "window", scope: !117, file: !1, line: 5, baseType: !121, size: 32, offset: 64)
!121 = !DIDerivedType(tag: DW_TAG_typedef, name: "MPI_Win", file: !5, line: 296, baseType: !6)
!122 = !DILocation(line: 24, column: 11, scope: !93)
!123 = !DILocation(line: 25, column: 7, scope: !93)
!124 = !DILocation(line: 25, column: 13, scope: !93)
!125 = !DILocalVariable(name: "ctx2", scope: !93, file: !1, line: 26, type: !126)
!126 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !117, size: 64)
!127 = !DILocation(line: 26, column: 12, scope: !93)
!128 = !DILocation(line: 29, column: 7, scope: !93)
!129 = !DILocation(line: 33, column: 7, scope: !93)
!130 = !DILocation(line: 34, column: 9, scope: !93)
!131 = !DILocation(line: 34, column: 15, scope: !93)
!132 = !DILocation(line: 28, column: 3, scope: !93)
!133 = !DILocation(line: 37, column: 24, scope: !93)
!134 = !DILocation(line: 37, column: 3, scope: !93)
!135 = !DILocation(line: 40, column: 7, scope: !93)
!136 = !DILocation(line: 44, column: 7, scope: !93)
!137 = !DILocation(line: 47, column: 11, scope: !93)
!138 = !DILocation(line: 39, column: 3, scope: !93)
!139 = !DILocation(line: 51, column: 7, scope: !93)
!140 = !DILocation(line: 55, column: 7, scope: !93)
!141 = !DILocation(line: 58, column: 7, scope: !93)
!142 = !DILocation(line: 58, column: 13, scope: !93)
!143 = !DILocation(line: 50, column: 3, scope: !93)
!144 = !DILocation(line: 61, column: 24, scope: !93)
!145 = !DILocation(line: 61, column: 3, scope: !93)
!146 = !DILocation(line: 63, column: 22, scope: !93)
!147 = !DILocation(line: 63, column: 3, scope: !93)
!148 = !DILocation(line: 65, column: 3, scope: !93)
!149 = !DILocation(line: 67, column: 3, scope: !93)
!150 = !DILocation(line: 69, column: 3, scope: !93)
