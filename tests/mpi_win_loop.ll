; ModuleID = 'mpi_win_loop.cpp'
source_filename = "mpi_win_loop.cpp"
...
; <label>:29:                                     ; preds = %47, %26
  %30 = load i64, i64* %10, align 8, !dbg !136
  %31 = icmp ult i64 %30, 3, !dbg !137
  br i1 %31, label %32, label %50, !dbg !135

; <label>:32:                                     ; preds = %29
  %33 = load i32, i32* %8, align 4, !dbg !138
  %34 = icmp sgt i32 %33, 0, !dbg !141
  br i1 %34, label %35, label %41, !dbg !142

; <label>:35:                                     ; preds = %32
  %36 = bitcast i32* %8 to i8*, !dbg !143
  %37 = load i32, i32* %8, align 4, !dbg !145
  %38 = sext i32 %37 to i64, !dbg !145
  %39 = load i32, i32* %9, align 4, !dbg !146
  %40 = call i32 @MPI_Get(i8* %36, i32 1, i32 1275069445, i32 0, i64 %38, i32 1, i32 1275069445, i32 %39), !dbg !147
  br label %47, !dbg !148

; <label>:41:                                     ; preds = %32
  %42 = bitcast i32* %8 to i8*, !dbg !149
  %43 = load i32, i32* %8, align 4, !dbg !151
  %44 = sext i32 %43 to i64, !dbg !151
  %45 = load i32, i32* %9, align 4, !dbg !152
  %46 = call i32 @MPI_Put(i8* %42, i32 1, i32 1275069445, i32 0, i64 %44, i32 1, i32 1275069445, i32 %45), !dbg !153
  br label %47

; <label>:47:                                     ; preds = %41, %35
  %48 = load i64, i64* %10, align 8, !dbg !154
  %49 = add i64 %48, 1, !dbg !154
  store i64 %49, i64* %10, align 8, !dbg !154
  br label %29, !dbg !135, !llvm.loop !155

; <label>:50:                                     ; preds = %29
  %51 = load i64, i64* %10, align 8, !dbg !157
  %52 = icmp ne i64 0, %51, !dbg !159
  br i1 %52, label %53, label %56, !dbg !160

; <label>:53:                                     ; preds = %50
  %54 = load i32, i32* %9, align 4, !dbg !161
  %55 = call i32 @MPI_Win_fence(i32 0, i32 %54), !dbg !163
  br label %56, !dbg !164

; <label>:56:                                     ; preds = %53, %50
  %57 = call i32 @MPI_Win_free(i32* %9), !dbg !165
  %58 = call i32 @MPI_Comm_free(i32* %7), !dbg !166
  %59 = call i32 @MPI_Finalize(), !dbg !167
  ret i32 0, !dbg !168
}
...
define linkonce_odr i32 @_Z13create_windowImEiiPT_b(i32, i64*, i1 zeroext) #3 comdat !dbg !169 {
  %4 = alloca i32, align 4
  ...
  call void @llvm.dbg.declare(metadata i64** %5, metadata !178, metadata !DIExpression()), !dbg !179
  %9 = zext i1 %2 to i8
  ...
  %10 = load i32, i32* %4, align 4, !dbg !186
  store i32 %10, i32* %8, align 4, !dbg !185
  %11 = load i64*, i64** %5, align 8, !dbg !187
  %12 = bitcast i64* %11 to i8*, !dbg !187
  %13 = load i32, i32* %8, align 4, !dbg !188
  %14 = call i32 @MPI_Win_create(i8* %12, i64 8, i32 1, i32 469762048, i32 %13, i32* %7), !dbg !189
  %15 = load i32, i32* %7, align 4, !dbg !190
  ret i32 %15, !dbg !191
}
...
!1 = !DIFile(filename: "mpi_win_loop.cpp", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!136 = !DILocation(line: 54, column: 10, scope: !93)
!137 = !DILocation(line: 54, column: 12, scope: !93)
!138 = !DILocation(line: 55, column: 9, scope: !139)
!139 = distinct !DILexicalBlock(scope: !140, file: !1, line: 55, column: 9)
!140 = distinct !DILexicalBlock(scope: !93, file: !1, line: 54, column: 17)
...
!155 = distinct !{!155, !135, !156}
!156 = !DILocation(line: 80, column: 3, scope: !93)
!157 = !DILocation(line: 82, column: 12, scope: !158)
!158 = distinct !DILexicalBlock(scope: !93, file: !1, line: 82, column: 7)
!159 = !DILocation(line: 82, column: 9, scope: !158)
!160 = !DILocation(line: 82, column: 7, scope: !93)
!161 = !DILocation(line: 83, column: 22, scope: !162)
!162 = distinct !DILexicalBlock(scope: !158, file: !1, line: 82, column: 15)
!163 = !DILocation(line: 83, column: 5, scope: !162)
!164 = !DILocation(line: 84, column: 3, scope: !162)
!165 = !DILocation(line: 86, column: 3, scope: !93)
!166 = !DILocation(line: 88, column: 3, scope: !93)
!167 = !DILocation(line: 90, column: 3, scope: !93)
!168 = !DILocation(line: 92, column: 3, scope: !93)
!169 = distinct !DISubprogram(name: "create_window<unsigned long>", linkageName: "_Z13create_windowImEiiPT_b", scope: !1, file: !1, line: 4, type: !170, isLocal: false, isDefinition: true, scopeLine: 4, flags: DIFlagPrototyped, isOptimized: false, unit: !0, templateParams: !174, variables: !2)
!170 = !DISubroutineType(types: !171)
!171 = !{!117, !4, !172, !173}
!172 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !67, size: 64)
!173 = !DIBasicType(name: "bool", size: 8, encoding: DW_ATE_boolean)
!174 = !{!175}
!175 = !DITemplateTypeParameter(name: "T", type: !67)
!176 = !DILocalVariable(name: "comm", arg: 1, scope: !169, file: !1, line: 4, type: !4)
!177 = !DILocation(line: 4, column: 33, scope: !169)
!178 = !DILocalVariable(name: "mem", arg: 2, scope: !169, file: !1, line: 4, type: !172)
!179 = !DILocation(line: 4, column: 42, scope: !169)
!180 = !DILocalVariable(name: "flag", arg: 3, scope: !169, file: !1, line: 4, type: !173)
!181 = !DILocation(line: 4, column: 52, scope: !169)
!182 = !DILocalVariable(name: "window", scope: !169, file: !1, line: 5, type: !117)
!183 = !DILocation(line: 5, column: 11, scope: !169)
!184 = !DILocalVariable(name: "comm_to_use", scope: !169, file: !1, line: 6, type: !4)
!185 = !DILocation(line: 6, column: 12, scope: !169)
!186 = !DILocation(line: 6, column: 26, scope: !169)
!187 = !DILocation(line: 9, column: 7, scope: !169)
!188 = !DILocation(line: 13, column: 7, scope: !169)
!189 = !DILocation(line: 8, column: 3, scope: !169)
!190 = !DILocation(line: 17, column: 10, scope: !169)
!191 = !DILocation(line: 17, column: 3, scope: !169)
