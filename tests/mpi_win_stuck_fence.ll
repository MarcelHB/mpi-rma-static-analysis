; ModuleID = 'mpi_win_stuck_fence.cpp'
source_filename = "mpi_win_stuck_fence.cpp"
...
; <label>:28:                                     ; preds = %2
  %29 = bitcast i32* %8 to i8*, !dbg !134
  %30 = load i32, i32* %8, align 4, !dbg !136
  %31 = sext i32 %30 to i64, !dbg !136
  %32 = load i32, i32* %9, align 4, !dbg !137
  %33 = call i32 @MPI_Put(i8* %29, i32 1, i32 1275069445, i32 0, i64 %31, i32 1, i32 1275069445, i32 %32), !dbg !138
  %34 = load i32, i32* %9, align 4, !dbg !139
  %35 = call i32 @MPI_Win_fence(i32 0, i32 %34), !dbg !140
  br label %36

; <label>:36:                                     ; preds = %28, %22
  %37 = load i32, i32* %9, align 4, !dbg !141
  %38 = call i32 @MPI_Win_fence(i32 0, i32 %37), !dbg !142
  %39 = call i32 @MPI_Win_free(i32* %9), !dbg !143
  %40 = call i32 @MPI_Comm_free(i32* %7), !dbg !144
  %41 = call i32 @MPI_Finalize(), !dbg !145
  ret i32 0, !dbg !146
}
...
!1 = !DIFile(filename: "mpi_win_stuck_fence.cpp", directory: "/home/marcelhb/Source/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!134 = !DILocation(line: 45, column: 9, scope: !135)
!135 = distinct !DILexicalBlock(scope: !125, file: !1, line: 43, column: 10)
!136 = !DILocation(line: 49, column: 9, scope: !135)
!137 = !DILocation(line: 52, column: 9, scope: !135)
!138 = !DILocation(line: 44, column: 5, scope: !135)
!139 = !DILocation(line: 55, column: 22, scope: !135)
!140 = !DILocation(line: 55, column: 5, scope: !135)
!141 = !DILocation(line: 58, column: 20, scope: !93)
!142 = !DILocation(line: 58, column: 3, scope: !93)
