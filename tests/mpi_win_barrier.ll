; ModuleID = 'mpi_win_barrier.cpp'
source_filename = "mpi_win_barrier.cpp"
...
define i32 @main(i32, i8**) #0 !dbg !93 {
  ...
  store i32 0, i32* %8, align 4, !dbg !111
  ...
  %12 = bitcast i64* %6 to i8*, !dbg !116
  %13 = call i32 @MPI_Win_create(i8* %12, i64 8, i32 1, i32 469762048, i32 1140850688, i32* %9), !dbg !117
  %14 = load i32, i32* %9, align 4, !dbg !118
  %15 = call i32 @MPI_Win_fence(i32 0, i32 %14), !dbg !119
  %16 = bitcast i32* %8 to i8*, !dbg !120
  %17 = load i32, i32* %7, align 4, !dbg !121
  %18 = sext i32 %17 to i64, !dbg !121
  %19 = load i32, i32* %9, align 4, !dbg !122
  %20 = call i32 @MPI_Get(i8* %16, i32 1, i32 1275069445, i32 0, i64 %18, i32 1, i32 1275069445, i32 %19), !dbg !123
  %21 = call i32 @MPI_Barrier(i32 1140850688), !dbg !124
  %22 = bitcast i32* %8 to i8*, !dbg !125
  %23 = load i32, i32* %7, align 4, !dbg !126
  %24 = sext i32 %23 to i64, !dbg !126
  %25 = load i32, i32* %9, align 4, !dbg !127
  %26 = call i32 @MPI_Put(i8* %22, i32 1, i32 1275069445, i32 0, i64 %24, i32 1, i32 1275069445, i32 %25), !dbg !128
  %27 = load i32, i32* %9, align 4, !dbg !129
  %28 = call i32 @MPI_Win_fence(i32 0, i32 %27), !dbg !130
  %29 = call i32 @MPI_Win_free(i32* %9), !dbg !131
  %30 = call i32 @MPI_Finalize(), !dbg !132
  ret i32 0, !dbg !133
}
...
!1 = !DIFile(filename: "mpi_win_barrier.cpp", directory: "/home/marcelhb/Sources/master_docs/passes/phasar/tests")
!2 = !{}
!3 = !{!4, !7, !8}
...
!110 = !DILocalVariable(name: "value", scope: !93, file: !1, line: 7, type: !6)
!111 = !DILocation(line: 7, column: 18, scope: !93)
!112 = !DILocation(line: 9, column: 3, scope: !93)
!113 = !DILocalVariable(name: "window", scope: !93, file: !1, line: 11, type: !114)
!114 = !DIDerivedType(tag: DW_TAG_typedef, name: "MPI_Win", file: !5, line: 296, baseType: !6)
!115 = !DILocation(line: 11, column: 11, scope: !93)
!116 = !DILocation(line: 13, column: 7, scope: !93)
!117 = !DILocation(line: 12, column: 3, scope: !93)
!118 = !DILocation(line: 21, column: 20, scope: !93)
!119 = !DILocation(line: 21, column: 3, scope: !93)
!120 = !DILocation(line: 24, column: 7, scope: !93)
!121 = !DILocation(line: 28, column: 7, scope: !93)
!122 = !DILocation(line: 31, column: 7, scope: !93)
!123 = !DILocation(line: 23, column: 3, scope: !93)
!124 = !DILocation(line: 34, column: 3, scope: !93)
!125 = !DILocation(line: 37, column: 7, scope: !93)
!126 = !DILocation(line: 41, column: 7, scope: !93)
!127 = !DILocation(line: 44, column: 7, scope: !93)
!128 = !DILocation(line: 36, column: 3, scope: !93)
!129 = !DILocation(line: 47, column: 20, scope: !93)
!130 = !DILocation(line: 47, column: 3, scope: !93)
!131 = !DILocation(line: 49, column: 3, scope: !93)
!132 = !DILocation(line: 51, column: 3, scope: !93)
!133 = !DILocation(line: 53, column: 3, scope: !93)
